...
@Autonomous(name = "BlueQuarryPlace", group = "Qualifier")
public class BlueQuarryPlace extends LinearOpMode {
    //Vuforia Setup
    ...
    final double DISTANCE_TO_DELIVER = 110;
    final double DISTANCE_TO_FOUNDATION = 32;
    final double DISTANCE_AFTER_PLACE = 24;
    final double DISTANCE_TO_PARK = 68;
    ...
    public void scanForSkyStone(VuforiaTrackable stoneTarget)
    {
        ...
        runtime.reset();
        targetVisible = false;
        while (targetVisible == false && opModeIsActive() && count < 4) {
            if(!firstMove)
            {
                //Use Encoder
    ...
    public void alignWithSkyStone(VuforiaTrackable stoneTarget)
    {
        ...
        //Target Position
        double blockPos = currentPos - targetShift + 1;//plus 4 because of the the distance betweeen the camera and the sensors
    ...
    public void deliverStone()
    {
        ...
        double distanceToDrive = DISTANCE_TO_DELIVER - skyStoneBot.getNavigation().frontDistance();
    ...
    public void driveToFoundation()
    {
        ...
        double distanceToDrive = DISTANCE_TO_FOUNDATION - skyStoneBot.getNavigation().frontDistance();
    ...
    public void placeStone()
    {
        ...
        double distanceToDrive = skyStoneBot.getNavigation().frontDistance() - DISTANCE_AFTER_PLACE;
    ...
    {
        encoderTurn(WHEEL_SPEED, -90, 5);
        double distanceToDrive = DISTANCE_TO_PARK - skyStoneBot.getNavigation().backDistance();
