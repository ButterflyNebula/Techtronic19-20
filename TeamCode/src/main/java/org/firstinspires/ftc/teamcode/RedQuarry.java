...
*/
    ...
    public void preparation()
    {
        ...
        //Move to the Left into the Depot
    ...
    public void alignWithSkyStone(VuforiaTrackable stoneTarget)
    {
        ...
        double currentPos = skyStoneBot.getNavigation().leftDistance();

        double targetShift = translation.get(1)/mmPerInch;

        //Target Position
        double blockPos = currentPos + targetShift + 5;//plus 5 because of the the distance betweeen the camera and the sensors
    ...
    public void deliverStone1()
    {
        ...
        //Turn 90 degrees to the right to face the bridge
    ...
    public void releaseStone()
    {
        ...
        encoderScissor(SCISSOR_UP_SPEED, 3, 3);
