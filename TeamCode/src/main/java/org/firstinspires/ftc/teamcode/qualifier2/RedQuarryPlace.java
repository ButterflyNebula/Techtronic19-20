...
@Disabled
@Autonomous(name = "RedQuarryPlace", group = "Qualifier")
public class RedQuarryPlace extends LinearOpMode {
    //Vuforia Setup
    ...
    public void straightenLeft(double timeOut)
    {
        ...
        while(Math.abs(angle) > 15 && opModeIsActive() && senseTime.seconds() < timeOut)
        {
            ...
            telemetry.addData("Front Right", skyStoneBot.getNavigation().backLeftDistance());
            telemetry.update();
        }
        if(angle > 50)
        {
